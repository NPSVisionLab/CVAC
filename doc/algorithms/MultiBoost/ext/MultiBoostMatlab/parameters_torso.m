...
objects.name{1} = 'marine+standing+az0deg,marine+walking+az0deg';
objects.name{2} = 'marine+standing+az90deg,marine+walking+az90deg';
objects.name{3} = 'marine+standing+az270deg,marine+walking+az270deg';
objects.name{4} = 'marine+standing+az180deg,marine+walking+az180deg';


objetos = 'marine,marines,civilian,policeman,coyote';


paramfile = 'demoMarine';
paramfile2 = 'detecttorso';
% DATABASES FOLDERS:
...
normalizedObjectSize = [128 48]; % size of object in a normalized frame (= [max height, max width])
