function [boxes,scores,clas] = DetectWeapons(img,box)
 %% HERE DETECT THE RIFLES USING THE ROI OF THE BODY DETECTED
    %% WITH AN INCREASED WIDTH OF 15% FOR EACH SIDE OF THE BOUNDING BOX
    ...
    fn1='cascades\haar_rifle0.xml';
    fn2='cascadeS\haar_rifle180.xml';
    fn3='cascades\haar_rifle225.xml';
    fn4='cascades\haar_rifle270.xml';
    fn4='cascades\haar_rifle315.xml';
